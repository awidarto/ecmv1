...
Route::controller(array('document','user','message','myhr','import','chart','graph','template','download','contact','project','tender','opportunity','search','activity','finance','hr','qc','warehouse','employee','requests','approval','category','content','ajax'));
