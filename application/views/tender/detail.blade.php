		...
		<div class="eight columns">
			...
			<table class="profile-info">
				<tr>
					...
					<td class="detail-info">{{ $project['tenderManager'] }}</td>
				</tr>
				<tr>
					<td class="detail-title">Preparation Start Date</td>
					<td class="detail-info">	
						<span>{{date('d-m-Y',$project['prepStartDate']->sec)}}</span>
					</td>
				</tr>
				<tr>
					<td class="detail-title">Submission Date</td>
					<td class="detail-info">	
						<span>{{date('d-m-Y',$project['submitDate']->sec)}}</span>
					</td>
				</tr>
				<tr>
					<td class="detail-title">Gross Value</td>
					<td class="detail-info">{{ $project['tenderCurrency'].' '.number_format($project['tenderGrossValue'],2,',','.') }}</td>
				</tr>
				<tr>
					<td class="detail-title">Nett Value</td>
					<td class="detail-info">{{ $project['tenderCurrency'].' '.number_format($project['tenderNetValue'],2,',','.') }}</td>
				</tr>
				<tr>
