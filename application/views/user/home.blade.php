...
@section('content')
      <!-- Feed Entry -->
      <div class="row">
        <div class="three columns mobile-one"><img src="http://placehold.it/80x80&text=[img]" /></div>
        <div class="thirteen columns">
          ...
          <h6>2 Comments</h6>
          <div class="row">
            <div class="three columns mobile-one"><img src="http://placehold.it/50x50&text=[img]" /></div>
            <div class="thirteen columns"><p>Bacon ipsum dolor sit amet nulla ham qui sint exercitation eiusmod commodo, chuck duis velit. Aute in reprehenderit</p></div>
          </div>
          <div class="row">
            <div class="three columns mobile-one"><img src="http://placehold.it/50x50&text=[img]" /></div>
            <div class="thirteen columns"><p>Bacon ipsum dolor sit amet nulla ham qui sint exercitation eiusmod commodo, chuck duis velit. Aute in reprehenderit</p></div>
